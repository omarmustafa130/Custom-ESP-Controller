...
(library Library_1
	...
	(symbolDef "MAX3232EIDR" (originalName "MAX3232EIDR")
	...
	(compDef "MAX3232EIDR" (originalName "MAX3232EIDR") (compHeader (numPins 16) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "DOUT2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "RIN2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "14" (pinName "DOUT1") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "13" (pinName "RIN1") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "12" (pinName "ROUT1") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "11" (pinName "DIN1") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "DIN2") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "ROUT2") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MAX3232EIDR"))
		...
		(attr "Mouser Part Number" "595-MAX3232EIDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/MAX3232EIDR?qs=paYhMW8qfitfJfSGA3hpAQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "MAX3232EIDR")
		(attr "Description" "3-V to 5.5-V multichannel RS-232 line driver and receiver with +/-15-kV IEC ESD protection")
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/max3232e")
		(attr "Height" "1.75 mm")
	)
